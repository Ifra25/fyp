...
from .models import User,Customer,Employee, MyAdmin
...
class AdminSignUpForm(UserCreationForm):
    ...
    def save(self):
        ...
        MyAdmin.phone_number=self.cleaned_data.get('phone_number')
        MyAdmin.designation=self.cleaned_data.get('designation')
        MyAdmin.save()
        return user